  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8 animate-fade-in">
        <div className="w-14 h-14 mx-auto mb-4 flex items-center justify-center rounded-2xl bg-gradient-to-br from-yellow-500 to-orange-500 text-white shadow-lg shadow-yellow-500/20">
          <Image className="w-7 h-7" />
        </div>
        <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-2">JPG to PDF</h1>
        <p className="text-slate-500 dark:text-slate-400">Convert your JPG images into a PDF document</p>
      </div>

      {/* Dropzone */}
      <div className="animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
        <FileDropzone onFilesSelected={setFiles} accept=".jpg,.jpeg,.png" multiple maxFiles={50} />
      </div>
      ...
      {/* Progress */}
      <div className="mt-6">
        <ProgressBar progress={progress} status="Converting images..." show={loading} />
      </div>
      ...
      {result && (
        <div className="mt-8 animate-fade-in-up">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/20 border border-green-200 dark:border-green-800 rounded-2xl p-6 text-center mb-6">
            ...
            <p className="text-green-600 dark:text-green-400 text-sm mt-1">{files.length} images combined into one document</p>
          </div>
